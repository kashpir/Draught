...
namespace UnitTests
{
    ...
    public class TestPosition
    {
        ...
        {
            var arrangement = new SetOfDraughts("wb2; wc3;");
            var position = new Position(arrangement, Peculiarity.Colours.White);
        ...
        {
            var arrangement = new SetOfDraughts("wb2; bc3; wd4");
            var position = new Position(arrangement, Peculiarity.Colours.White);
        ...
        {
            var arrangement = new SetOfDraughts("bc3; wb2; wd2; wf2;");
            var position = new Position(arrangement, Peculiarity.Colours.Black);
            Assert.AreEqual(2, position.Takings().Count());
        }
        [Test]
        ...
        {
            var arrangement = new SetOfDraughts("wa1; wc1; bb2; bb4; bb6; wc3;");
            var position = new Position(arrangement, Peculiarity.Colours.Black);
