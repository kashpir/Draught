...
namespace UnitTests
{
    ...
    public class TestTakings
    {
        ...
        {
            var arrangement = new SetOfItems("wa3; bb4; bb2");
            var position = new Position(arrangement, ColourNames.White);
            var moves = position.Moves();
        ...
        {
            var arrangement = new SetOfItems("wa3; bb4; bd6; bf6; bh4");
            var position = new Position(arrangement, ColourNames.White);
            var moves = position.Moves();
            Assert.AreEqual(1, moves.Count());
        ...
        {
            var arrangement = new SetOfItems("wc3; bb4; bb6; bd6; bd4");
            var position = new Position(arrangement, ColourNames.White);
            var moves = position.Moves();
            Assert.AreEqual(2, moves.Count());
            ...
            Assert.AreEqual(true, moves.Moves[0].AreEqual(4,square));
            Assert.AreEqual(true, moves.Moves[1].AreEqual(4,square));
        }
        [Test]
        public void TestTaking5()
        {
            var arrangement = new SetOfItems("wc3; wd4; wc5; we3; bf4; bd6;");
        ...
        {
            var arrangement = new SetOfItems("wc3; wc5; we3; wc7; bf4; bd6; bb8");
            var position = new Position(arrangement, ColourNames.Black);
            var moves = position.Moves();
            Assert.AreEqual(2, moves.Count());
            Assert.AreEqual(3, moves.Moves[0].Points.Count);
        ...
        {
            var arrangement = new SetOfItems("wc3; wc5; wc7; we3; we5; we7; bf8");
            var position = new Position(arrangement, ColourNames.Black);
            var moves = position.Moves();
            Assert.AreEqual(3, moves.Count());
        }
        ...
        {
            var arrangement = new SetOfItems("wc3; wc5; wg3; we3; we5; we7; bf8");
            var position = new Position(arrangement, ColourNames.Black);
            var moves = position.Moves();
